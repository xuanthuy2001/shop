<div class="navbar-custom">
      <ul class="list-unstyled topbar-right-menu float-right mb-0">
            ...
            <li class="dropdown notification-list topbar-dropdown">
                  <a class="nav-link dropdown-toggle arrow-none" data-toggle="dropdown" href="#" role="button"
                        aria-haspopup="false" aria-expanded="false">
                        <img src="{{asset('template/assets/images/flags/us.jpg')}}" alt="user-image"
                              class="mr-0 mr-sm-1" height="12">
                  ...
                  <div class="dropdown-menu dropdown-menu-right dropdown-menu-animated topbar-dropdown-menu">
                        ...
                        <!-- item-->
                        <a href="javascript:void(0);" class="dropdown-item notify-item">
                              <img src="{{asset('template/assets/images/flags/spain.jpg')}}" alt="user-image"
                  ...
                  <div class="dropdown-menu dropdown-menu-right dropdown-menu-animated dropdown-lg p-0">
                        ...
                        <div class="p-2">
                              <div class="row no-gutters">
                                    <div class="col">
                                          <a class="dropdown-icon-item" href="#">
                                                <img src="{{asset('template/assets/images/brands/slack.png')}}"
                                                      alt="slack">
                                                <span>Slack</span>
                                          </a>
                                    </div>
                              ...
                              <div class="row no-gutters">
                                    ...
                                    <div class="col">
                                          <a class="dropdown-icon-item" href="#">
                                                <img src="{{asset('template/assets/images/brands/g-suite.png')}}"
                                                      alt="G Suite">
                                                <span>G Suite</span>
                                          </a>
                                    </div>
      ...
      <div class="app-search dropdown d-none d-lg-block">
            ...
            <div class="dropdown-menu dropdown-menu-animated dropdown-lg" id="search-dropdown">
                  <!-- item-->
                  <div class="dropdown-header noti-title">
                        <h5 class="text-overflow mb-2">Found <span class="text-danger">17</span>
                              results</h5>
                  </div>
                  ...
                  <div class="notification-list">
                        ...
                        <a href="javascript:void(0);" class="dropdown-item notify-item">
                              <div class="media">
                                    <img class="d-flex mr-2 rounded-circle"
                                          src="{{asset('template/assets/images/users/avatar-2.jpg')}}"
                        ...
                        <a href="javascript:void(0);" class="dropdown-item notify-item">
                              <div class="media">
                                    <img class="d-flex mr-2 rounded-circle"
                                          src="{{asset('template/assets/images/users/avatar-5.jpg')}}"
                                          alt="Generic placeholder image" height="32">
                                    <div class="media-body">
